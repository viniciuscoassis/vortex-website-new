export const explorersABI = [
  {
    type: "constructor",
    inputs: [
      { name: "_unrevealedURI", type: "string", internalType: "string" },
      { name: "_trustedSigner", type: "address", internalType: "address" },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "revealedURIs", type: "string[]", internalType: "string[]" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  },
  {
    ...
    name: "mintWithTraits",
    inputs: [
      { name: "traitsJson", type: "string", internalType: "string" },
  ...
  },
  {
    ...
    inputs: [
      { name: "tokenId", type: "uint256", internalType: "uint256" },
      { name: "revealedURI", type: "string", internalType: "string" },
    ],
    outputs: [],
    stateMutability: "nonpayable",
  },
  ...
  { type: "error", name: "Explorer__ContractPaused", inputs: [] },
  { type: "error", name: "Explorer__InsufficientPayment", inputs: [] },
  { type: "error", name: "Explorer__InvalidSignature", inputs: [] },
  { type: "error", name: "Explorer__LengthMismatch", inputs: [] },
  { type: "error", name: "Explorer__MaxSupplyReached", inputs: [] },
  { type: "error", name: "Explorer__NotAuthorized", inputs: [] },
  { type: "error", name: "Explorer__TransferFailed", inputs: [] },
  {
    type: "error",
